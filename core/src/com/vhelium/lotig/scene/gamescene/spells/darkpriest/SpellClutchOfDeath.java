...
public class SpellClutchOfDeath extends Spell
{
	public static String name = "Clutch of Death";
	public static String debuffAsset = "Clutch of Death Debuff";
	public static String effectAsset = "Clutch of Death";
	...
	public static void activate(int shooterId, int spellLevel, DataPacket dp, Realm realm)
	{
		...
		ohe.setSoundEffect(SoundFile.spell_ghost1);
