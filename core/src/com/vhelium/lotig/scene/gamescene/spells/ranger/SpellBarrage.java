...
{
	public static String name = "Barrage";
	public static String bulletAsset = "Barrage";
	
	public static float cooldownBase = 10000;
	...
	public static float damageBonusPerLevel = 6;
	
	public static int rangeBase = 150;
	public static int rangePerLevel = 5;
	
	static float force = 1.8f;
	static float decay = 0.89f;
	...
	{
		return "You fire a barrel of arrows hitting all enemies in front of you.\nEach enemy hit will be knocked back.\n\nDamage: " + getDamage(getLevel()) + " - " + (getDamage(getLevel()) + getBonusDamage(getLevel())) + "\nRange: " + getRange(getLevel());
	}
	...
	public static void activate(int shooterId, int spellLevel, DataPacket dp, Realm realm)
	{
		...
		BulletOnHitEffect ohe = new BulletOnHitEffect(getDamage(level) + GameHelper.getInstance().getRandom().nextInt((int) getBonusDamage(level) + 1), 0, null, new MovementModifier("Barrage", dirX, dirY, force, decay));
