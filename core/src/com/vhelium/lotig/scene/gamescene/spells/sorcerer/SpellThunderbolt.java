...
public class SpellThunderbolt extends Spell
{
	...
	public static String bulletAsset = "Thunderbolt";
	...
	public static void activate(int shooterId, int spellLevel, DataPacket dp, Realm realm)
	{
		...
		realm.shoot(shooterId, false, DamageType.Lightning, getRange(level), x - GameHelper.getInstance().getBulletAsset(bulletAsset).getWidth() / 2 + dirX * 16, y - GameHelper.getInstance().getBulletAsset(bulletAsset).getHeight() / 2 + dirY * 16, rotation, dirX, dirY, bulletAsset, effect);
	}
	
	@Override
	public String getCastSound()
	{
		return SoundFile.spell_lightning_cast;
	}
