...
public class SpellExplosiveShot extends Spell
{
	public static String name = "Explosive Shot";
	public static String bulletAsset = "Explosive Shot";
	public static String effectAsset = "Fireball";
	
	public static float cooldownBase = 15000;
	...
	public static int rangeBase = 450;
	public static int rangePerLevel = 15;
	
	public static int aoeRadiusBase = 75;
	public static int aoeRadiusPerLevel = 7;
	
	public SpellExplosiveShot()
	{
		instantCast = false;
	}
