...
public class SpellCriticalStrike extends Spell
{
	public static String name = "Critical Strike";
	public static String bulletAsset = "Critical Strike";
